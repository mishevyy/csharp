...
Блокировки нужны для управления доступом к данным. Что бы в один момент доступ к данным был только у одко потока. Управлять блокировками необходимо только в том случае, если разные потоки могут редактировать данные. Желательно строить приложения таким образом, что бы блокировок потоков не происходило
